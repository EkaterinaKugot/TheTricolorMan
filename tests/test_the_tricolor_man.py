...
def test_str_question():
    question = Question("вопрос?", [Answer(AnswerType.RED, "ответ1"), Answer(AnswerType.GREEN, "ответ2"),
                                    Answer(AnswerType.BLUE, "ответ3")])
    assert question.__str__() == "Question: вопрос?\nAnswer: ответ1 AnswerType.RED\nAnswer: ответ2 AnswerType.GREEN\nAnswer: ответ3 AnswerType.BLUE"
...
def test_checking_answer_selected():
     assert Test.checking_answer_selected({"answ1": False, "answ2": True, "answ3": False}) == True
